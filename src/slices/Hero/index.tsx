...
const Hero = ({ slice }: HeroProps): JSX.Element => {
  ...
  return (
    <Bounded
      ...
      ref={component}
    >
      <div className="grid m-h-[70vh] grid-cols-1 md:grid-cols-2 items-center">
        <Shapes />
      ...
      >
          ...
          <span className="-mt-[.2em] block text-slate-500">
            ...
            <span className="job-title block bg-gradient-to-tr from-yellow-500 via-yellow-200 to to-yellow-500 
